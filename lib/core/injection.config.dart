...
import 'package:focus_timer/cubit/timer_cubit.dart' as _i7;
...
import 'package:focus_timer/services/window_service.dart' as _i6;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.singleton<_i6.WindowService>(() => _i6.WindowService());
    gh.factory<_i7.TimerCubit>(() => _i7.TimerCubit(
          gh<_i3.DatabaseRepository>(),
          gh<_i5.NotificationService>(),
          gh<_i4.MacOSService>(),
          gh<_i6.WindowService>(),
        ));
    return this;
  }
}
